...
AWS CloudFormation is at its core a Infrastructure as Code (IaC) framework. This allows for AWS resources to be deployed and managed via code. 
...
Citation - [What is AWS CloudFormation?](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html)